...
- ✅ サブコミュニティ5つ（英語、IT、野球塾、スカウト、キャリア）
- ✅ 監修者セクション
- ✅ お問い合わせフォーム
- ✅ お役立ちコラム（モーダル表示）
...
| **キャッチコピー文字数** | **25〜35文字**を目安に作成。スマホ表示で2行に収まる長さを推奨 |
...
```
✅ 良い例（35文字以内）:
「日本一14回の超名門。ジャイアンツカップ4回優勝。」
「DeNA阪口皓亮を輩出。団結・友愛・規律を育むチーム。」
「泉州大会主催。保護者のお茶当番なしで活動。」

❌ 長すぎる例（40文字以上）:
「2015年ジャイアンツカップ全国制覇。ダルビッシュ有・太田椋らプロ選手を輩出する超名門。」
→ スマホ表示で途中で切れてしまう
```
